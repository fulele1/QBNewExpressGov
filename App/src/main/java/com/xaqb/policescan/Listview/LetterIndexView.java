package com.xaqb.policescan.Listview;
...
public class LetterIndexView extends LinearLayout {
    ...
    public void init(OnTouchLetterIndex touchLetterIndex) {
        ...
        this.setBackgroundColor(getResources().getColor(R.color.wirte));
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        ...
                        LetterIndexView.this.setBackgroundColor(getResources().getColor(R.color.text_c));
                    ...
                    case MotionEvent.ACTION_UP:
                        LetterIndexView.this.setBackgroundColor(getResources().getColor(R.color.wirte));
                        if (LetterIndexView.this.touchLetterIndex != null) {
                            //调用接口

...
public class LogBillAdapter extends ListBaseAdapter<LogBill> {
    Context mContext;
    public LogBillAdapter(Context context) {
        super(context);
        mContext = context;
    }
    ...
    public int getLayoutId() {
        return R.layout.list_log_bill;
    }
    @Override
    public void onBindItemHolder(SuperViewHolder holder, int position) {
        final LogBill item = mDataList.get(position);

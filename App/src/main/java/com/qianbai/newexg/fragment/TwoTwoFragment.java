...
import com.qianbai.newexg.RLview.LogAdapter;
...
public class TwoTwoFragment extends BaseFragment {
    ...
    private TwoTwoFragment.PreviewHandler mHandler = new TwoTwoFragment.PreviewHandler(this);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        instance = TwoTwoFragment.this.getActivity();
...
//        list_r.addItemDecoration(divider);
    ...
    List<Log> mClue = new ArrayList<>();;
    List<Log> mClues = new ArrayList<>();
    private void connecting(int p) {

        android.util.Log.e("fule",HttpUrlUtils.getHttpUrl().log_list()+"?access_token="+ SPUtils.get(instance,"access_token","")+"&p="+p);
        RestClient.builder()
...
//                .params("","")
                        ...
                        if (NullUtil.getString(map1.get("state")).equals("0")) {
                            if (!count.equals("0")){
                                ...
                                for (Map<String, Object> map : list1) {
                                    ...
                                    com.setOrg( NullUtil.getString(map.get("querysecurityorg")));
                                    com.setAdd( NullUtil.getString(map.get("queryaddress")));
                                    com.setDate( NullUtil.getString(map.get("querydate")));
                                    com.setCom( NullUtil.getString(map.get("querycom")));
    ...
    private void addItems(ArrayList<Log> list) {
    ...
    private class PreviewHandler extends Handler {
        ...
        private WeakReference<TwoTwoFragment> ref;

        PreviewHandler(TwoTwoFragment activity) {
            ref = new WeakReference<>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            final TwoTwoFragment activity = ref.get();

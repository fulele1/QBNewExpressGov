...
public class TwoOneFragment extends BaseFragment {
    ...
    private TwoOneFragment.PreviewHandler mHandler = new TwoOneFragment.PreviewHandler(this);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        instance = TwoOneFragment.this.getActivity();
...
//                .params("","")
    ...
    private class PreviewHandler extends Handler {
        ...
        private WeakReference<TwoOneFragment> ref;

        PreviewHandler(TwoOneFragment activity) {
            ref = new WeakReference<>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            final TwoOneFragment activity = ref.get();

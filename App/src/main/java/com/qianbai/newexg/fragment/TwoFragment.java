...
public class TwoFragment extends BaseFragment {
    ...
    private TwoFragment.PreviewHandler mHandler = new TwoFragment.PreviewHandler(this);
                    ...
                    public void onSuccess(String response) {
                        ...
                        if (NullUtil.getString(map1.get("state")).equals("0")) {
                            ...
                            for (Map<String, Object> map : list1) {
                                ...
                                com.setOrg(NullUtil.getString(map.get("querysecurityorg")));//管辖机构
                                com.setAdd(NullUtil.getString(map.get("queryaddress")));//地址
                                com.setDate(NullUtil.getString(map.get("querydate")));//日期
                                com.setCom(NullUtil.getString(map.get("querycom")));//查询企业
                                com.setUser(NullUtil.getString(map.get("queryuser")));//查询人员
